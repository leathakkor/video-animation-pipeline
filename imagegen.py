...
class Drawer_Image:
    ...
    def renderImage(self, x_size, y_size, state):
        ...
        #img = self.__comp.generator(self.__comp.size[0], self.__comp.size[1], state)
        #for part in self.__comp.parts:
